...
export default function ExpandableAppointmentTable({
    ...
    return (
        <div className={`space-y-2 ${Object.entries(groupedAppointments).length <= 3 ? "pb-32" : ""}`}>
                                                ...
                                                <div className="relative" ref={menuRef}>
                                                    ...
                                                    {openMenuId === appointment.id && (
                                                        <div className="absolute right-0 mt-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50 min-w-48">
                                                            ...
                                                            <button
                                                                onClick={() => {
                                                                    console.log("Reschedule request for:", appointment);
                                                                    setOpenMenuId(null);
                                                                }}
                                                            ...
                                                            <button
                                                                ...
                                                                className="w-full px-4 py-2.5 text-left text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 flex items-center gap-3 last:rounded-b-lg"
                                                            >
                                                                <svg
                                                                    className="w-4 h-4"
                                                                    fill="none"
