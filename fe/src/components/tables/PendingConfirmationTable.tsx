...
export default function PendingConfirmationTable({
    ...
    return (
        <div className={`rounded-2xl border ${appointments.length <= 5 && 'mb-32'} border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] overflow-hidden`}>
                                ...
                                >
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-2">
                                            {isOverdue && (
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-orange-600 dark:text-orange-400 flex-shrink-0">
