...
const OAuthFacebookCallback = lazy(
  () => import('./pages/AuthPages/OAuthFacebookCallback')
);
...
const DoctorVerification = lazy(
  () => import('./pages/DoctorVerification/DoctorVerification')
);
const VerificationDetail = lazy(
  () => import('./pages/DoctorVerification/VerificationDetail')
);
const AppointmentList = lazy(
  () => import('./pages/AppointmentManagement/AppointmentList')
);
const AppointmentDetail = lazy(
  () => import('./pages/AppointmentManagement/AppointmentDetail')
);
const AppointmentStatistics = lazy(
  () => import('./pages/AppointmentManagement/AppointmentStatistics')
);
...
const PrescriptionTemplates = lazy(
  () => import('./pages/PrescriptionManagement/PrescriptionTemplates')
);
const PaymentList = lazy(() => import('./pages/PaymentManagement/PaymentList'));
const PaymentDetail = lazy(
  () => import('./pages/PaymentManagement/PaymentDetail')
);
const RefundList = lazy(() => import('./pages/PaymentManagement/RefundList'));
const RefundDetail = lazy(
  () => import('./pages/PaymentManagement/RefundDetail')
);
...
const BackupMaintenance = lazy(
  () => import('./pages/BackupMaintenance/BackupMaintenance')
);
const BackupDashboard = lazy(
  () => import('./pages/BackupMaintenance/BackupDashboard')
);
const BackupHistory = lazy(
  () => import('./pages/BackupMaintenance/BackupHistory')
);
const ManualBackup = lazy(
  () => import('./pages/BackupMaintenance/ManualBackup')
);
const RestoreBackup = lazy(
  () => import('./pages/BackupMaintenance/RestoreBackup')
);
const ScheduledMaintenance = lazy(
  () => import('./pages/BackupMaintenance/ScheduledMaintenance')
);
const SystemOptimization = lazy(
  () => import('./pages/BackupMaintenance/SystemOptimization')
);
const NotificationCenter = lazy(
  () => import('./pages/Notifications/NotificationCenter')
);
const TimeSlotCalendar = lazy(
  () => import('./pages/TimeSlotManagement/TimeSlotCalendar')
);
const TimeSlotList = lazy(
  () => import('./pages/TimeSlotManagement/TimeSlotList')
);
...
const ReceptionistAppointments = lazy(
  () => import('./pages/Receptionist/ReceptionistAppointments')
);
const ReceptionistAppointmentDetail = lazy(
  () => import('./pages/Receptionist/Appointments/AppointmentDetail')
);
const ReceptionistPatients = lazy(
  () => import('./pages/Receptionist/ReceptionistPatients')
);
const ReceptionistQueue = lazy(
  () => import('./pages/Receptionist/ReceptionistQueue')
);
const ReceptionistPayments = lazy(
  () => import('./pages/Receptionist/ReceptionistPayments')
);
const ReceptionistReports = lazy(
  () => import('./pages/Receptionist/ReceptionistReports')
);
const ReceptionistSettings = lazy(
  () => import('./pages/Receptionist/ReceptionistSettings')
);
...
const DepartmentDetailPage = lazy(
  () => import('./pages/Landing/DepartmentDetailPage')
);
...
const DoctorProfilePage = lazy(
  () => import('./pages/Landing/DoctorProfilePage')
);
...
const ServiceDetailPage = lazy(
  () => import('./pages/Landing/ServiceDetailPage')
);
...
const PatientSettingsLayout = lazy(
  () => import('./pages/Patient/PatientSettingsLayout')
);
...
const DoctorConsultation = lazy(
  () => import('./pages/Doctor/DoctorConsultation')
);
const DoctorPrescriptions = lazy(
  () => import('./pages/Doctor/DoctorPrescriptions')
);
const DoctorPatients = lazy(() => import('./pages/Doctor/DoctorPatients'));
const DoctorReviews = lazy(() => import('./pages/Doctor/DoctorReviews'));
const DoctorProfileSetup = lazy(
  () => import('./pages/Doctor/DoctorProfileSetup')
);
const DoctorVerificationCenter = lazy(
          ...
          <Routes>
            ...
            <Route element={<LandingLayout />}>
              ...
              <Route element={<ProtectedRoute />}>
                <Route
                  ...
                  element={<PatientSettingsLayout />}
                >
                  <Route
                    index
                    element={
                      <Navigate to='/patient/settings/appointments' replace />
                    }
                  />
            ...
            <Route element={<ProtectedRoute />}>
              <Route element={<AppLayout />}>
                ...
                <Route
                  path='/admin/timeslot-calendar'
                  element={<TimeSlotCalendar />}
                />
                <Route path='/admin/timeslot-list' element={<TimeSlotList />} />
                <Route
                  path='/admin/timeslot-bulk-create'
                  element={<TimeSlotBulkCreate />}
                />
                <Route
                ...
                />
                <Route
                  path='/admin/prescription-list/:id'
                ...
                <Route
                  ...
                  element={<BackupMaintenance />}
                />
                <Route
                  path='/admin/backup-dashboard'
                  element={<BackupDashboard />}
                />
                <Route
                  path='/admin/backup-history'
                  element={<BackupHistory />}
                />
                <Route path='/admin/manual-backup' element={<ManualBackup />} />
                <Route
                  path='/admin/restore-backup'
                ...
                />
                <Route
                  path='/admin/system-optimization'
                  element={<SystemOptimization />}
                />
            ...
            <Route element={<DoctorProtectedRoute />}>
              <Route path='/doctor' element={<DoctorLayout />}>
                ...
                <Route
                  ...
                  element={<DoctorScheduleWeekly />}
                />
                <Route
                  path='schedule/time-off-breaks'
                  element={<DoctorScheduleTimeOff />}
                />
                <Route
                ...
                <Route
                  ...
                  element={<DoctorPrescriptionsCreate />}
                />
                <Route
                  path='prescriptions/history'
                  element={<DoctorPrescriptionsHistory />}
                />
                <Route
                  path='prescriptions/templates'
                  element={<DoctorPrescriptionsTemplates />}
                />
                ...
                <Route
                  ...
                  element={<DoctorPatientsMyPatients />}
                />
                <Route
                  path='patients/recent'
                  element={<DoctorPatientsRecent />}
                />
                <Route
                  path='patients/chronic-allergy-flags'
                  element={<DoctorPatientsChronic />}
                />
                <Route
