...
export default function DoctorAppointmentsUpcoming() {
  ...
  const uniqueDates = useMemo(() => {
    const dates = new Set(
      processedAppointments.map((apt) => apt.appointmentDate)
    );
  ...
  const handleViewDetails = async (appointment: AppointmentDTO) => {
    ...
    try {
      const details = await appointmentService.getDoctorAppointmentDetail(
        appointment.id
      );
  ...
  const handleOpenRescheduleModal = (appointment: AppointmentDTO) => {
                  ...
                  <div className='p-3 bg-orange-100 rounded-lg dark:bg-orange-900/30'>
                    ...
                    >
                      <path
                        strokeLinecap='round'
                        strokeLinejoin='round'
                        d='M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.995-1.039'
                      />
                    </svg>
                  </div>
                </div>
