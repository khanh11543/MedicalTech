    ...
    <div className="landing-page min-h-screen">
      ...
      >
        <div className="header-container container mx-auto max-w-7xl flex items-center justify-between px-6">
          ...
          {/* CTA Button + Login + Mobile Toggle */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="text-sm text-gray-500 space-y-1">
                ...
                <p className="mt-3"><strong className="text-gray-700">Phone:</strong> +1 5589 55488 55</p>
                <p><strong className="text-gray-700">Email:</strong> info@meditrust.com</p>
              </div>
