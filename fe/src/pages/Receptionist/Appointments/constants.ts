...
export const ACTIONS_PER_STATUS: Record<string, string[]> = {
  PENDING: ["VIEW", "CONFIRM", "RESCHEDULE", "CANCEL"],
  CONFIRMED: ["CHECK_IN", "RESCHEDULE", "CANCEL", "SEND_REMINDER", "PRINT_SLIP"],
  CHECKED_IN: ["VIEW_QUEUE", "MARK_NO_SHOW", "NOTIFY_DOCTOR"],
  IN_PROGRESS: ["VIEW"],
  COMPLETED: ["COLLECT_PAYMENT", "RECEIPT", "CREATE_FOLLOW_UP"],
